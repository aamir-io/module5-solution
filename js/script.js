$(function () { 
  // Hides the navbar when focus is lost on mobile
...
(function (global) {
  ...
  function insertItemPrice(html, pricePropName, price) {
    price = price ? "$" + price.toFixed(2) : "";
    return insertProperty(html, pricePropName, price);
  }

  function insertItemPortionName(html, portionPropName, portionName) {
    return insertProperty(html, portionPropName, portionName || "");
  }
  global.$dc = dc;
})(window);
